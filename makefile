SOURCES = src/attacks.cpp src/bitboards.cpp src/main.cpp src/makemove.cpp src/move.cpp src/movegen.cpp src/perft.cpp src/position.cpp src/uci.cpp src/libchess/src/movegen.cpp src/search.cpp src/eval.cpp src/PST.cpp src/misc.cpp src/globals.cpp src/hash.cpp src/draw.cpp src/sort.cpp
